...
namespace FarmExp.CommonLibary
{
    ...
    /// <summary>
    /// RSACryptoServiceOpenSSL加减密
    /// </summary>
   public class RSACryptoServiceOpenSSL
   {
       private RSACryptoServiceProvider _privateKeyRsaProvider;
       private RSACryptoServiceProvider _publicKeyRsaProvider;

       public RSACryptoServiceOpenSSL(string privateKey, string publicKey = null)
       {
       ...
       /// <summary>
       /// 创建一个私钥RSACryptoServiceProvider
       /// </summary>
       ...
       /// <summary>
       /// 创建一个公钥RSACryptoServiceProvider 
       /// </summary>
